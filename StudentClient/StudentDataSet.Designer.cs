...
namespace StudentClient {
    ...
    public partial class StudentDataSet : global::System.Data.DataSet {
        ...
        public partial class AttendanceDataTable : global::System.Data.TypedTableBase<AttendanceRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AttendanceRow AddAttendanceRow(int StuId, string Attendance) {
            ...
            private void InitClass() {
                ...
                this.columnAttendance.MaxLength = 100;
            }
        ...
        public partial class AttendanceRow : global::System.Data.DataRow {
            ...
            public int StuId {
                get {
                    try {
                        return ((int)(this[this.tableAttendance.StuIdColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'StuId\' in table \'Attendance\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableAttendance.StuIdColumn] = value;
                }
            }
            ...
            public bool IsStuIdNull() {
                return this.IsNull(this.tableAttendance.StuIdColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetStuIdNull() {
                this[this.tableAttendance.StuIdColumn] = global::System.Convert.DBNull;
            }
...
namespace StudentClient.StudentDataSetTableAdapters {
    ...
    public partial class AttendanceTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Attendance] WHERE (([AttendanceId] = @Original_AttendanceId) A" +
                "ND ((@IsNull_StuId = 1 AND [StuId] IS NULL) OR ([StuId] = @Original_StuId)) AND " +
                "((@IsNull_Attendance = 1 AND [Attendance] IS NULL) OR ([Attendance] = @Original_" +
                "Attendance)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Attendance] ([StuId], [Attendance]) VALUES (@StuId, @Attendanc" +
                "e);\r\nSELECT AttendanceId, StuId, Attendance FROM Attendance WHERE (AttendanceId " +
                "= SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Attendance] SET [StuId] = @StuId, [Attendance] = @Attendance WHERE (([AttendanceId] = @Original_AttendanceId) AND ((@IsNull_StuId = 1 AND [StuId] IS NULL) OR ([StuId] = @Original_StuId)) AND ((@IsNull_Attendance = 1 AND [Attendance] IS NULL) OR ([Attendance] = @Original_Attendance)));
SELECT AttendanceId, StuId, Attendance FROM Attendance WHERE (AttendanceId = @AttendanceId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::StudentClient.Properties.Settings.Default.StudentConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT AttendanceId, StuId, Attendance FROM dbo.Attendance";
        ...
        public virtual int Delete(int Original_AttendanceId, global::System.Nullable<int> Original_StuId, string Original_Attendance) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_AttendanceId));
            if ((Original_StuId.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[2].Value = ((int)(Original_StuId.Value));
            }
            else {
        ...
        public virtual int Insert(global::System.Nullable<int> StuId, string Attendance) {
        ...
        public virtual int Update(global::System.Nullable<int> StuId, string Attendance, int Original_AttendanceId, global::System.Nullable<int> Original_StuId, string Original_Attendance, int AttendanceId) {
            if ((StuId.HasValue == true)) {
            ...
            if ((Original_StuId.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_StuId.Value));
            }
            else {
            ...
            if ((Original_Attendance == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_Attendance));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> StuId, string Attendance, int Original_AttendanceId, global::System.Nullable<int> Original_StuId, string Original_Attendance) {
            return this.Update(StuId, Attendance, Original_AttendanceId, Original_StuId, Original_Attendance, Original_AttendanceId);
        }
    }
